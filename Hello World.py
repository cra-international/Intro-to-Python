...
#Now you try! Replace "<whatever you want!>" with, well, whatever you want and 
#run the code below
...
#Strings are text and created in Python using with double or single quotes
#Hint: Use double quotes when you want to include a single quote in the string 
#and vice versa
str1 = "I'm a string!"
...
#Now you try! Change the code below to change the boolean variable to an 
#integer and check the newtype!
...
#Now you try! Write code below to print the boolean value of "Hello World!"
